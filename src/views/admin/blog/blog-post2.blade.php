                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <select class="form-control get-key" name="category" id="">
                                    ...
                                    @if (Base::show_all_menu())
                                    @foreach (Base::show_all_menu() as $key=>$item)
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Title"
                                    value="{{ Base::show_blog_post() != NULL ? Base::show_blog_post()->title : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="sub_title" placeholder="Sub Title"
                                    value="{{ Base::show_blog_post() != NULL ? Base::show_blog_post()->sub_title : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="author" placeholder="Author"
                                    value="{{ Base::show_blog_post() != NULL ? Base::show_blog_post()->author : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <img src="{{asset(''.Base::show_blog_post()->photo)}}" alt="" style="width:
                                112px;
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <textarea id="" name="description" class="form-control" cols="30"
                                    rows="10">{{ Base::show_blog_post() != NULL ? Base::show_blog_post()->description : '' }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="color" class="form-control" name="post_color" placeholder="Post Color"
                                    value="{{ Base::show_blog_post() != NULL ? Base::show_blog_post()->post_color : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="post_status" placeholder="Post Status"
                                    value="{{ Base::show_blog_post() != NULL ? Base::show_blog_post()->post_status : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="post_tag" placeholder="Post Tag"
                                    value="{{ Base::show_blog_post() != NULL ? Base::show_blog_post()->post_tag : '' }}">
                            </div>
                        </div>
