                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="card-body inbox-panel">
                                                    <div class="nav flex-column nav-pills" id="v-pills-{{ $key }}"
                                                        ...
                                                        $j = 1;
                                                        @endphp
                                                        @foreach ($item as $key=>$sectionButton)
                                                            {{-- @php
                                                                dd($key);
                                                            @endphp --}}
                                                            <a class="nav-link {{ $j==1?'active':'' }}"
                                                                ...
                                                                aria-controls="v-pills-{{$key}}-subhome"
                                            ...
                                            <div class="col-9">
                                                ...
                                                <div class="tab-content" id="v-pills-tabContent">
                                                    ...
                                                    @if (BlogPackage::array_depth($item) > 2)    
                                                                                                ...
                                                                                                <div class="card-body">
                                                                                                    ...
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <div class="input-group mb-3">
                                                                                                            ...
                                                                                                            $value =
                                                                                                            BlogPackage::get_cms_data()->$key->$single_block_keys->$label->value;
                                                                                                            }
                                                                                                            @endphp
                                                                                        ...
                                                                                        @else
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div class="input-group mb-3">
                                                                                                    @php
                                                                                                    $value =
                                                                                                    BlogPackage::get_cms_data()->$key->$single_block_keys->value;
                                                                                                    @endphp
                                                                                                    ...
                                                                                                    <img style="height:50px;margin:10px 0px;" value=""
                                                                                                        src="/{{ $value }}" alt="">
                                                                                                    <input type="hidden"
                                                                                                        name="{{$key.'_'.$single_block_keys}}_image_old"
                                                                                                        value="{{$value}}">
                                                                                                    <input type="file" class="form-control"
                                                                                                        name="{{ $key.'_'.$single_block_keys }}"
                                                                                                        placeholder=" {{ strtoupper( str_replace('_',' ',$single_block_keys))}}"
