...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Add BlogPackage Information</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Add BlogPackage Information</li>
                </ol>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="f_name" placeholder="FirstName"
                                    value="{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->f_name : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="l_name" placeholder="LastName"
                                    value="{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->l_name : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control" name="email" placeholder="Email"
                                    value="{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->email : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="mobile_one" placeholder="Mobile One"
                                    value="{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->mobile_one : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="mobile_two" placeholder="Mobile Two"
                                    value="{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->mobile_two : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="country" placeholder="Country"
                                    value="{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->country : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="state" placeholder="State"
                                    value="{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->state : '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <textarea name="address" class="form-control" name="address" id="" cols="30" rows="10"
                                    value="">{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->address : '' }}</textarea>
                                {{-- <input type="text" class="form-control" name="address" placeholder="Address" value="{{ BlogPackage::show_all_basic() != NULL ? BlogPackage::show_all_basic()->address : '' }}">
                                --}}
                            </div>
                        </div>
                        <div class="form-group">
